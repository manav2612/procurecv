...
- [ ] **Not yet confirmed**: whether the live site works end-to-end after this fix redeploys (record -> transcribe -> appears in dashboard) — needs the user to redeploy and check.
